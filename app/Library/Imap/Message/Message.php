...
class Message implements MessageInterface, Htmlable
{
    ...
    protected function processStruct($structure, $partId = null)
    {
        ...
        // non fa altro che analizzare la struttura che gli viene passata e se il messaggio ha delle sottoparti,
        // chiama ricorsivamente processStruct per ogni sotto parte
        ...
        if(isset($params['name']) || isset($params['filename']) ||
            ...
            return $recurse($structure); // se è un allegato non serve andare oltre
        }
